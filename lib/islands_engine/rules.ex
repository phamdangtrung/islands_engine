defmodule IslandsEngine.Rules do
  ...
  def terminate(_reason, _state, _datrA), do: :nothing
  ...
  @spec player2_turn(any, any, any) ::
          {:keep_state_and_data, {:reply, any, :player2_turn}}
          | {:next_state, :game_over | :player1_turn, any, {:reply, any, :ok}}
          | {:reply, {:error, :action_out_of_sequence}, :player2_turn, any}
  ...
  def player2_turn({:call, from}, _caller_pid, _state) do
